...
setup(
    ...
    description='lite version of the transport modelling framework quetzal',
    long_description=long_description,

    # The project's main homepage.
    url='https://gitlab.systra.info/probin/quetzal',

    # Author details
    author='SYSTRA, marlinarnz',
    author_email='qchasserieau@systra.com',
